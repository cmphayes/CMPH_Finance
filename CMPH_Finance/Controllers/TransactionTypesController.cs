...
namespace CMPH_Financial.Controllers
{
    public class TransactionTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Type")] TransactionType transactionType)
        {
            if (ModelState.IsValid)
            {

                transactionType.CreatedBy = User.Identity.GetUserId();
                transactionType.Created = DateTimeOffset.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Type")] TransactionType transactionType)
        {
            if (ModelState.IsValid)
            {
